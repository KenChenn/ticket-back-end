...
public class UpdateCommodityReq {
	...
	private List<UpdateSessionReq> SessionData;

	public UpdateCommodityReq() {
		super();
		// TODO Auto-generated constructor stub
	}

	public UpdateCommodityReq(int id, String codeName, String name, String introduction, boolean entity,
			LocalDate startDate, LocalDate endDate, String place, String keyvisual_img, String introduce_img1,
			String introduce_img2, String organizer, List<UpdateSessionReq> sessionData) {
		super();
		this.id = id;
	...
	public List<UpdateSessionReq> getSessionData() {
		return SessionData;
	}

	public void setSessionData(List<UpdateSessionReq> sessionData) {
		SessionData = sessionData;
	}
